...
class ProtocolLEDENETAddressableChristmas(ProtocolLEDENETAddressableBase):
    ...
    def construct_preset_pattern(
        ...
        """The bytes to send for a preset pattern.
        DEBUG:__main__:TCP ('192.168.213.28', 63443) <= 0xB0 0xB1 0xB2 0xB3 0x00 0x01 0x01 0x2A 0x00 0x04 0x38 0x01 0x10 0x00 0x3F (15)
        DEBUG:__main__:TCP ('192.168.213.28', 63443) <= 0xB0 0xB1 0xB2 0xB3 0x00 0x01 0x01 0x2B 0x00 0x04 0x38 0x02 0x10 0x00 0x41 (15)
        DEBUG:__main__:TCP ('192.168.213.28', 63443) <= 0xB0 0xB1 0xB2 0xB3 0x00 0x01 0x01 0x2C 0x00 0x04 0x38 0x03 0x10 0x00 0x43 (15)
        DEBUG:__main__:TCP ('192.168.213.28', 63443) <= 0xB0 0xB1 0xB2 0xB3 0x00 0x01 0x01 0x2D 0x00 0x04 0x38 0x04 0x10 0x00 0x45 (15)
        DEBUG:__main__:TCP ('192.168.213.28', 63443) <= 0xB0 0xB1 0xB2 0xB3 0x00 0x01 0x01 0x2E 0x00 0x04 0x38 0x05 0x10 0x00 0x47 (15)
        DEBUG:__main__:TCP ('192.168.213.28', 63443) <= 0xB0 0xB1 0xB2 0xB3 0x00 0x01 0x01 0x2F 0x00 0x04 0x38 0x06 0x10 0x00 0x49 (15)
        """
        return self.construct_wrapped_message(
            bytearray(
                [
